...
export class MovielistComponent extends BaseListCtl implements OnInit {
  ...
  validateInput(event: any, field: string) {
    ...
    if (field === 'mobile') {
      ...
      const nameTermValue = Number(value);
      this.isValidNameInput = nameTermValue >= 0 && nameTermValue <=10;
      this.nameErrorMessage = this.isValidNameInput ? '' : 'Please type a number between 1 and 10';
